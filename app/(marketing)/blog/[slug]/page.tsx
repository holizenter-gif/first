  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="py-12 px-4">
        <div className="max-w-3xl mx-auto">
          {post.contenido ? (
            <div className="prose prose-lg max-w-none prose-headings:font-display prose-headings:text-brand-dark prose-headings:font-bold prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-h3:text-xl prose-p:text-gray-600 prose-p:leading-relaxed prose-strong:text-brand-dark prose-a:text-brand-teal prose-ul:text-gray-600 prose-li:my-1 prose-blockquote:border-l-4 prose-blockquote:border-brand-teal prose-table:w-full prose-th:bg-brand-dark prose-th:text-white prose-th:px-4 prose-th:py-2 prose-td:border prose-td:border-gray-200 prose-td:px-4 prose-td:py-2">
            ...
            <p className="text-gray-400 italic text-center py-8">
              El contenido está siendo editado.
            </p>
          )}
