  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-2xl">
        ...
        <h3 className="font-serif text-2xl font-bold text-[#1B4332] mb-3">¡Ya casi terminas!</h3>
        ...
        <div className="flex flex-col gap-3">
          <button onClick={onClose} className="w-full py-3 bg-[#D4A017] hover:bg-[#A67C0F] text-white font-semibold rounded-xl transition-colors">
