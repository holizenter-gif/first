          ...
          return (
            <button key={i} onClick={() => handleSelect(opcion.value)} disabled={animating}
              className={[
                ...
                isSelected ? "border-[#1B4332] bg-[#1B4332] text-white shadow-lg scale-[1.02]" : "border-gray-200 bg-white text-gray-700 hover:border-[#1B4332] hover:bg-[#F5F0E8] hover:shadow-md",
