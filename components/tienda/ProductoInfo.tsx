...
export default function ProductoInfo({ producto }: ProductoInfoProps) {
  return (
    <div>
      ...
      <h1 className="font-serif text-3xl font-bold text-brand-green mt-2">{producto.nombre}</h1>
      <div className="flex items-center gap-3 mt-4">
        <span className="text-4xl font-bold text-brand-green">${producto.precio.toLocaleString()}</span>
